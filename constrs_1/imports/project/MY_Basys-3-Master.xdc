...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { o_LED_UP_down  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
...
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { i_button[1] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { i_button[2] }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
